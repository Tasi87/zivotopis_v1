		...
		<section id="education" className="container-fluid py-5 education">
				<div className="container">
					...
					<p>
						...
						Inštruktor lezenia na umelých stenách a lanových prekážkách.
					</p>
					<p>
						<b>Inštruktor horolezectva 2. kvalifikačného stupňa</b> <br />
						Horolezecká škola JAMES <br />
						Inštruktor na skalách (v neveľhorskom teréne) a feratách.
					</p>
					<p>
						<b>Tréner športového lezenia 1. kvalifikačného stupňa</b> <br />
						Horolezecká škola JAMES <br />
					...
					<p>
						<b>Obsluha plynových technických zariadení skupiny A</b> <br />
